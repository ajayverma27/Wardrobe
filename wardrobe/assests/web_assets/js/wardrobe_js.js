...
$('#tab_5_btn').click(function(){
      ...
      $('#top-image-tab5').attr('src',baseurl+'assests/web_assets/img_web/View_from_above'+count+'.svg')
      var ins = ''
      for(var i=0;i<count;i++){
    ...
    //$('.dom_table6 table.table_num5').find('.grid_center').removeClass('grid_center');
})

$(document).on('click','#door_prev',function(){
    $('table.table_num5').addClass('grid_center');
})
...
$(document).on('focusout',".setInpCal",function(){
    var l = $('#length_check_0').val();
    var sv = $('.setInpCal').val();
    if(parseInt(sv) >= parseInt(l)){
        $('.setInpCal').val(200);
        calculate_door_section()
    }
    else
    {
        var thisl = $('.setInpCal').parents('.inside_table_tr').find('tr').length;
        var noin = $('.setInpCal').parents('.inside_table_tr').find('.framer_selections .setInpWidth').length;
        var intotal = 0;
        $('.setInpCal').parents('.inside_table_tr').find('.framer_selections .setInpWidth').each(function(){
            let vv = $(this).val();
            if(vv == ''){
                vv = 0;
                noin--;
    ...
    $('.setInpCal').removeClass('setInpCal');
});


// $(document).on('keyup','.section-tab6 .tab6-td .setInpWidth',function(){
//     $('.section-tab6 .tab6-td .setInpWidth').removeClass('setInpCal')
//     $(this).addClass('setInpCal');
//     let thisv = $(this).val();
//     if(thisv != ''){
//           var l = $('#length_check_0').val();
//           if(parseInt(thisv) > l){
//             val = thisv.substring(0,thisv.length - 1);
//             $(this).val(val)
//           }
//          calculate_door_section();
//     }
...
function cost_calculation(){
 ...
 spabscount = 4;  //new 16-05
       ...
       if(sidewall > 0){
        ...
        // body +=`<tr>
        // <th>
        //     Cena vrchnej police (x${ttc})
        //     <div class="align-items-center d-flex gap11">
        //         <span class="green_box_1 mt-3"></span>
        //         <span class=""> ${topshelfwidth}mm</span>
        //     </div>
        //     <span class=""> ${topshelflength}mm</span>
        // </th>
        // <td>`;
        var topth = '';
        var toptd = '';
       for(let n=0;n<ttc;n++){
           ...
           topth += `<div class="align-items-center d-flex gap11">
                <span class="green_box_1 mt-3"></span>
                <span class=""> ${topshelfcalcost[n].toFixed(2)}mm</span>
            </div>
            <span class=""> ${topshelfwidth.toFixed(2)}mm</span>`
     
            toptd +=`<span class="calc_panel">DTD Materiál</span> 
        ...
        if(ttc == (parseInt(n)+parseInt(1)))
            ...
            toptd += `<span class="calc_panel">Cena ABS</span> 
            <span class="calc_panel">=</span> 
        ...
        // <div class="align-items-center d-flex gap11">
        //             <span class="green_box_1 mt-3"></span>
        //             <span class=""> ${d-105}mm</span>
        //         </div>
        //         <span class=""> ${tilltopshefheight}mm</span>
        body +=`<tr>
            <th>
...
$('.section-tab6').find('.dom_table6 .tab6-td').each(function(){
    ...
    $(this).find('.set_inside_framer').each(function(){
        ...
        if($(this).find('input').length){
            ...
            lll = thisval;
             ...
             lll = $(this).find('td.framer_selections').text();
        }
        tabletr += `<tr><td style="height:50px; width:50px">${lll} mm</td></tr>`;
        i++;
    });
   ...
   if(i==1){
       ...
       if(noinput >= 1){
        ...
        let editedsectiontotalmaterialauto = editedautomaticalyheight*doorfillwidth;
...
let shelfwidthdisplay =  (w/count)-36;
                body +=`<tr>
               <th>
                    <div class="align-items-center d-flex gap11">
                        <span class="green_box_1 mt-3"></span>
                        <span class="">${d-105}mm </span>
                        <span class="calc_panel">X${no_shelves}</span>
                    </div>
                    <span class=""> ${shelfwidthdisplay.toFixed(0)}mm</span>
                </th>
                <td>
               ...
               let drawerheight = total_drawer/no_drawer;
            ...
            //     <span >
            //         <table class="tabtab" style="height:50px; width:50px">
            //             <tr><td>${shelflength}mm </td></tr>
            //         </table>
            //     </span>
            // </div>

            let frontbackwidth = (w/count)-27-36;
            let bottomwidth = (w/count)-27-36-3;
            let sideswidth = (w/count)-50;
             ...
             body +=`<tr class="tr-top">
                <th>
                    <div class="align-items-center d-flex gap11">
                        <span class="green_box_1 mt-3"></span>
                        <span class="">${d-105}mm </span>
                        <span class="calc_panel">X${no_drawer}</span>
                    </div>
                    <span class=""> ${frontbackwidth}mm</span>
                </th>
                <td>
                ...
                <th>
                    <div class="align-items-center d-flex gap11">
                        <span class="green_box_side mt-3"></span>
                        <span class="">${drawerheight}mm</span>
                        <span class="calc_panel">X${no_drawer}</span>
                    </div>
                    <span class="">${d-105}mm</span>
                </th>
                ...
                <th>
                    ...
                    <span class=""> ${bottomwidth}mm</span>
                </th>
                <td>
                ...
                <th>
                    ...
                    <span class=""> ${frontbackwidth.toFixed(0)}mm</span>
                </th>
                <td>
                ...
                <th>
                    <div class="align-items-center d-flex gap11">
                        <span class="green_box_side mt-3"></span>
                        <span class=""> ${total_drawer}mm</span>
                    </div>
                    <span class=""> ${d-105}mm</span>
                </th>
                <td>
...
let railwidthm = h/1000;
           ...
           let totalrailcost = parseFloat(totaltoprailcost)+parseFloat(totalbootomprailcost);
            ...
            <th>
               ...
               <div class="align-items-center d-flex gap11 pb-2">
                    <span class="small_green_box mt-3"></span>
                    <span class="ml-2 mt-3">${d-105}mm</span>
                </div>
                <span class="">27mm</span>
            </th>
            <td>
...
var gt = parseFloat(sidepanel) + parseFloat(sidepanelabs) + parseFloat(sidewall) + parseFloat(sidewallabs)  +  parseFloat(topshelf)  + parseFloat(topshelfabs) + parseFloat(dividerwall) +  parseFloat(dividerwallabs) + parseFloat(profilecal);
    ...
    let wardrobe_tcost_vat = wardrobe_tcost*1.2;
     $('.wardrobe-tcost-vat').text(wardrobe_tcost_vat.toFixed(2)+' €');
...
// ================== tab 4 JS ==========
    $(document).on('click','#tab_id_btn4',function(){
        ...
        // 10-06-2023
        $('img.interiér-skrine-img').attr('src','https://wardrobe.zarfrestauracia.sk/assests/web_assets/img_web/plus_icon_red.png');
        $('img.abs-img-cls').attr('src','https://wardrobe.zarfrestauracia.sk/assests/web_assets/img_web/plus_icon_red.png');
        $('img.stena-img').attr('src','https://wardrobe.zarfrestauracia.sk/assests/web_assets/img_web/plus_icon_red.png');
...
$(document).ready(function () {
  ...
  $(document).on('keyup',function(){
    ...
    $('#closet_open').on('click', function() {
         ...
         $('.dom_table6 table.table_num5').removeClass('grid_center');
    });
...
// sidebar modal image
$(document).ready(function(){
    $('.tab-5-main .Cabinet_interior').click(function(){
        $('.type-abcd-sidebar').find('.cab_modal_img').removeClass('cab_modal_img');
        $(this).addClass('cab_modal_img');
        $('#Cabinet_interior').modal('show');
    })
})
$(document).on('click','.interior_img_sidebar', function(){
    $('#Cabinet_interior').find('.sidebar_active_img').removeClass('sidebar_active_img');
    $(this).addClass('sidebar_active_img');
    confirm_materials()
})
// $(document).on('click','.dekor-confirm-btn', function(){
    function confirm_materials(){
        let src = $('.sidebar_active_img').attr('src');
    

        let prp = $('.cab_modal_img').attr('data-count');
        //alert(prp)
        $('.cabinet-interior-'+prp+' img').prop('src', src);

        if(prp == 2){
            $('.tab-5-main').find('.cust_width').css({ "background-image": "url("+ src +")", "background-size": "100% 100% !important" });
        }

        // $('.box_select').addClass('addWoodImg');
        // $('.box_select').css({ "background-image": "url(" + img + ")", "background-size": "100% 100% !important" });
        
        let h5Text = $('.sidebar_active_img').parents('.woodColorCls').find('h5').text();
        $('.cabinet-interior-'+prp).find('h6').text(h5Text);

        // let interiorImg = $('.Cabinet_interior.cab_modal_img').find('.interiér-skrine-img').attr('src');
        // $('.box_select').css({"background-image":"url("+interiorImg+")","background-size": "100% 100% !important"});
        
        $('#Cabinet_interior').modal('hide');
        if( $('#Cabinet_interior').find('.sidebar_active_img').hasClass('sidebar_active_img') == false ){
...
// })
function check_tab5btn(){
    let checkl = $('.tab-5-main .Cabinet_interior').length;
    let incment=0;
    $('.tab-5-main .Cabinet_interior').each(function(){
        let mat = $(this).find('.font-weight-bolder').text();
        if(mat){
            incment++;
        }
    })
    if(checkl == incment){
         ...
         $('#tab_5_btn').prop('disabled', true);
    }
}

// $('.sidebar_active_img').click(function(){
//     let name = $(this).attr('data-color');
//     let namesrc = $(this).attr('data-namesrc');
// })

// if($('.Cabinet_interior h6.my-1').is(':empty')){
//     $('.btn-green').attr('disabled');
// }else{
