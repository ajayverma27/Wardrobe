...
<a href="javascript:void(0)" id="tab4-table-1-New" class="select_div mr-20 tab4-tbls-list" onclick="getDom('table_1_new')">
<span id="table_1_new">
	<table id="check-radio-tbl" >
		<tbody>
			<tr class="set_frame_color">
				<td class="part_frame">
					<table class="inside_table_tr box_table_height">
						<tr class="set_inside_framer">
							<td class="framer_selections part2_section_new height_change_box"> 
								<span class="t4-btn">
		...
		<div class="col-lg-9">
			<div class="d-flex justify-content-center align-items-center flex-column">
				...
				<div class="">
                    ...
                    <ul class="g-text-tab4">
                    <li><img src="<?=base_url()?>assests/web_assets/img_web/plus_green.png" alt="" class="" style="">
                     Kliknutím zvolíte v danom priestore otvorený priestor</li>
                    <li><img src="<?=base_url()?>assests/web_assets/img_web/add_icon.png" alt="" class="" style="">
                    Kliknutím zvolíte v danom priestore šuflík</li>
                    <li>Bez výberu - V danom priestore zvolíte dvierka</li>
                    </ul>
				</div>
			</div>
			<!-- <div class="col-3">
	...
	<td>
		...
		<table>
			<tbody>
				<tr class="set_frame_color">
					<td class="set_frame_color part_frame">
						<table class="inside_table_tr height_change_box">
						<tbody>
							<tr class="set_inside_framer">
...
<!-- drawer modal -->
<div class="modal fade" id="editdrawerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  	<div class="modal-dialog modal-sm" role="document">
    	<div class="modal-content">
      		<div class="modal-header">
        		<!-- <h5 class="modal-title" id="exampleModalLabel">Potvrdiť</h5> -->
      		...
      		<div class="modal-body">
      			<div class="card d-types-clr mb-3">
      				<div class="col-md-12">
						<div class="">
							<div class="card card-shadow mb-3">
								<div class="card-body p-1">
									<div class="check-box">
										<input type="checkbox" name="" class="check check-right" id="wrawer_handle">
										<label for="wrawer_handle">
											<span class="f16">Úchytka </span>
										</label>
									</div>
								</div>
							</div>
							<div class="card card-shadow">
								<div class="card-body p-1">
									<div class="check-box">
										<input type="checkbox" name="" class="check check-right" id="wrawer_ps">
										<label for="wrawer_ps">
											<span class="f16">Push systém</span><br><small class="f9">Otvorí sa po stlačení</small>
										</label>
									</div>
      			...
      			<div class="field btns justify-content-center align-items-center mx-auto d-flex">
				   <button class="btn btn-danger drawer-btn-confirm" type="button">Potvrdiť</button>
			    </div>
      		</div>
  		</div>
	</div>
...
<a href="javascript:void(0)" class="btn btn-basic Späť_btn mt-25 prev-1 prev" id="tab_6"><i class="font-weight-bold icon mr-1 ti-arrow-left"></i> Späť</a>
	<div class="row">
...
<a href="javascript:void(0)" class="btn btn-basic Späť_btn mt-25 prev-1 prev"><i class="font-weight-bold icon mr-1 ti-arrow-left"></i> Späť</a>
	<div class="row tabb__8">
					...
					<div class="row">
						...
						<div class="col-md-9">
							<div class="d-flex justify-content-end align-items-cente Cena_s_PH" style="gap:18px;">
								...
								<div class="">
									<h3 class="font-weight-bold mb-0 ttl_price_vat" style="display:none">450,95€</h3>
                                    <small class="ttl_price" style="display:none"></small>
        ...
        <a href="javascript:void(0)" class="btn btn-basic Späť_btn mt-25 prev-1 prev"><i class="font-weight-bold icon mr-1 ti-arrow-left"></i> Späť</a>
			...
			<div class="col-md-4">
                <div  class="mobile-img-final"></div>
				<div class="row">
					<div class="col-md-6 col-6">
						<h3 class="text-dark font-weight-bolder text-left">Cena s DPH</h3>
                        <small>Cena bez DPH</small>
					</div>
					<div class="col-md-6 col-6">
						<h3 class="text-dark font-weight-bolder text-right ttl_price_vat" style="display:none"></h3>
                        <small class="text-right ttl_price w-100" style="display:none"></small>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="modal-dialog modal-dialog-centered first_modal_width" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-body p-0">
                ...
                <a href="https://www.facebook.com/sharer.php?u=<?=base_url('web/configurator')?>&t=Wardrobe" target="_blank" class="text-decoration-none mr-2">
					<img src="<?=base_url()?>assests/web_assets/img_web/fb.jpg" alt="facebook" class="img-responsive d-block m-auto lazy modal1_ss">
				</a>
				<a href="https://web.whatsapp.com/send?text=<?=base_url('web/configurator')?>" target="_blank" class="text-decoration-none mr-2">
