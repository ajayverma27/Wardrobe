...
<div class="table_inpField_top font14">
    <label for="top-height_inpField" style=""><b>Zadajte výšku vrchnej police</b></label>
    <input type="text" class="" id="top-height_inpField" placeholder=""> <span class="font14"><b>mm</b></span>
    <p style="font-size: 12px;">Pre výber interiéru skrine je najprv <br> potrebné zadať výšku vrchnej police</p>
...
<div class="row">
<div class="col-md-9">
<a href="javascript:void(0)" class="btn btn-basic Späť_btn mt-25 prev-1 prev" id="door_prev"><i class="font-weight-bolder icon mr-1 text-danger ti-arrow-left"></i> Späť</a>
<!-- <center>
							...
							<div class="col-md-3">
								<div class="d-flex justify-content-end">
									<div class="ttl_price" style="display:none">
										<h3 class="font-weight-bolder mb-0 wardrobe-total-cost wardrobe-tcost-vat">1480,95€</h3>
                                        <small class="wardrobe-tcost"></small>
									</div>
									<div class="ml-3">
			...
			<div class="tab10-col-3 col-md-3 position-relative mt-90">
				...
				<div class="row">
					...
					<div class="col-md-6 text-right ttl_price" style="display:none">
						<h4 class="font-weight-bolder mb-0 tab_10_cena wardrobe-tcost-vat">1 480,95€</h4>
                        <small class="wardrobe-tcost"></small>
...
<!-- Interiér skrine Modal -->

<div class="modal fade" id="Cabinet_interior" tabindex="-1" aria-labelledby="Cabinet_interiorModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="Cabinet_interiorModal">Interiér skrine - Pre potvrdenie výberu materiálu kliknite na tlačidlo potvrdiť.</h4>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div data-thick="<?= $price['thickness'] ?>" data-clr="<?= $price['color'] ?>" class="col-md-3 mb-3 color_fill_ins woodColorCls" >
                        <div class="border">
                            <img data-color="<?= $value['color'] ?>" data-namesrc="<?= base_url() . $value['image'] ?>" data-nameid="<?= $increment ?>" src="<?= base_url() . $price['image'] ?>" alt="" class="w-h-252 inside_clr interior_img_sidebar" id="sm-<?= $price['id'] ?>">
                        </div>
                        <div class="px-2 border">
                            <small><?= $price['thickness'] ?> mm</small>
                            <h5 id="tab5-mname-<?= $increment ?>"><?= $value['color'] ?></h5>
                        </div>
                    </div>
...
<!-- <div class="modal fade" id="ABS_modal" tabindex="-1" aria-labelledby="ABS_modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="ABS_modal">ABS</h4>
                <div class="search-section col-md-4">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div data-thick="<?= $price['thickness'] ?>" data-clr="<?= $price['color'] ?>" class="col-md-3 mb-3 color_fill_ins woodColorCls" >
                        <div class="border">
                            <img data-color="<?= $value['color'] ?>" data-namesrc="<?= base_url() . $value['image'] ?>" data-nameid="<?= $increment ?>" src="<?= base_url() . $price['image'] ?>" alt="" class="w-h-252 inside_clr">
                        </div>
                        <div class="px-2 border">
                            <small><?= $price['thickness'] ?> mm</small>
                            <h5 id="tab5-mname-<?= $increment ?>"><?= $value['color'] ?></h5>
