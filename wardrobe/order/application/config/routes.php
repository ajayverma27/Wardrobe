...
$route['order_management_details/(:any)'] = 'AdminController/order_management_details/$1';
$route['customer_management'] = 'AdminController/customer_management';
$route['employee_management'] = 'AdminController/employee_management';
$route['customer_management_profile/(:any)'] = 'AdminController/customer_management_profile/$1';
$route['generate_pdf'] = 'AdminController/generate_pdf';