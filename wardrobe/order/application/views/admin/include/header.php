                ...
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="#" class="d-lg-none">
                            <img alt="Logo" src="<?=base_url()?>assests/admin-assets/images/Logo_DENIR_PNG.png" class="h-30px" />
                        </a>
                    </div>
                    <?php 
                        $login_id =  $this->session->userdata('userdata');
                        $this->db->where("id",$login_id['users_id']);
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
                        <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
                            <div>
                                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Hi, <?php if(!empty($userdata->company)){ echo $userdata->company; }?></h1>
                        ...
                        <div class="app-navbar flex-shrink-0">
                            <div class="app-navbar-item ms-1 ms-lg-3">
                                <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                    <img src="<?=base_url()?>assests/admin-assets/images/notification.svg">
                                </div>
                                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px notification_box_radius" data-kt-menu="true">
                                    <div class="d-flex flex-column bgi-no-repeat rounded-top px-8">
                                        <h3 class="align-items-center d-flex fw-semibold justify-content-between  py-8 mt-2 border-bottom  notification_header">Notifications
                                            <span class="fs-8 opacity-75 read_color">Mark all as read <span><img src="<?=base_url()?>assests/admin-assets/images/sms.png" class=""></span></span>
                                        </h3>
                                    </div>
                                                        ...
                                                        <div class="symbol symbol-35px me-4">
                                                            <span class="symbol-label bg-light-primary">
                                                                <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                                    <img src="<?=base_url()?>assests/admin-assets/images/Icon.svg">
                                                                </span>
                                                            </span>
                                                        </div>
                                                        <div class="mb-0 me-2">
                                                            ...
                                                            <div><a href="#"  class="view_order_div">View Order<span class="ms-2"><img src="<?=base_url()?>assests/admin-assets/images/export.svg"></span></a></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-flex flex-stack py-4 align-items-baseline notification_header_box px-3">
                                                    <div class="d-flex ">
                                                        <div class="symbol symbol-35px me-4">
                                                            <span class="symbol-label bg-light-primary">
                                                                <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                                    <img src="<?=base_url()?>assests/admin-assets/images/Icon1.svg">
                                                                </span>
                                                            </span>
                                                        </div>
                                                        <div class="mb-0 me-2">
                                                ...
                                                <div class="d-flex flex-stack py-4 align-items-baseline notification_header_box px-3">
                                                    <div class="d-flex ">
                                                        <div class="symbol symbol-35px me-4">
                                                            <span class="symbol-label bg-light-primary">
                                                                <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                                    <img src="<?=base_url()?>assests/admin-assets/images/Icon2.svg">
                                                                </span>
                                                            </span>
                                                        </div>
                                                        <div class="mb-0 me-2">
                                                ...
                                                <div class="d-flex flex-stack py-4 align-items-baseline notification_header_box px-3">
                                                    <div class="d-flex ">
                                                        <div class="symbol symbol-35px me-4">
                                                            <span class="symbol-label bg-light-primary">
                                                                <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                                    <img src="<?=base_url()?>assests/admin-assets/images/Icon3.svg">
                                                                </span>
                                                            </span>
                                                        </div>
                                                        <div class="mb-0 me-2">
                                        ...
                                        <div class="tab-pane fade" id="kt_topbar_notifications_2" role="tabpanel">
                                            <div class="d-flex flex-column px-9">
                                                ...
                                                <div class="text-center px-4">
                                                    <img class="mw-100 mh-200px" alt="image" src="<?=base_url()?>assests/admin-assets/media/illustrations/sketchy-1/1.png" />
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="app-navbar-item ms-1 ms-lg-3">
                                <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                    <img src="<?=base_url()?>assests/admin-assets/images/message-text.svg">
                                </div>
                                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px notification_box_radius" data-kt-menu="true">
                                    <div class="d-flex flex-column bgi-no-repeat rounded-top px-8">
                                                ...
                                                <div class="d-flex flex-stack py-4 align-items-baseline notification_header_box px-3">
                                                    <div class="d-flex ">
                                                        <div class="symbol symbol-35px me-4">
                                                            <span class="symbol-label bg-light-primary">
                                                                <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                                    <img src="<?=base_url()?>assests/admin-assets/images/Image-msg1.svg">
                                                                </span>
                                                            </span>
                                                        </div>
                                                        <div class="mb-0 me-2">
                                                ...
                                                <div class="d-flex flex-stack py-4 align-items-baseline notification_header_box px-3">
                                                    <div class="d-flex ">
                                                        <div class="symbol symbol-35px me-4">
                                                            <span class="symbol-label bg-light-primary">
                                                                <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                                    <img src="<?=base_url()?>assests/admin-assets/images/Image-msg2.svg">
                                                                </span>
                                                            </span>
                                                        </div>
                                                        <div class="mb-0 me-2">
                                                ...
                                                <div class="d-flex flex-stack py-4 align-items-baseline notification_header_box px-3">
                                                    <div class="d-flex ">
                                                        <div class="symbol symbol-35px me-4">
                                                            <span class="symbol-label bg-light-primary">
                                                                <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                                    <img src="<?=base_url()?>assests/admin-assets/images/Image-msg3.svg">
                                                                </span>
                                                            </span>
                                                        </div>
                                                        <div class="mb-0 me-2">
                                                ...
                                                <div class="d-flex flex-stack py-4 align-items-baseline notification_header_box px-3">
                                                    <div class="d-flex ">
                                                        <div class="symbol symbol-35px me-4">
                                                            <span class="symbol-label bg-light-primary">
                                                                <span class="svg-icon svg-icon-2 svg-icon-primary">
                                                                    <img src="<?=base_url()?>assests/admin-assets/images/Image-msg4.svg">
                                                                </span>
                                                            </span>
                                                        </div>
                                                        <div class="mb-0 me-2">
                            ...
                            <!-- <div class="app-navbar-item ms-1 ms-lg-3  z-index-3" id="kt_header_user_menu_toggle">
                                <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                    <img src="<//?=base_url()?>assests/admin-assets/images/Avatar.png" alt="user" />
                                </div>
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            <div class="symbol symbol-50px me-5">
                                                <img alt="Logo" src="<//?=base_url()?>assests/admin-assets/images/Avatar.png" />
                                            </div>
                                            <div class="d-flex flex-column">
                                          
                                                <div>
                                <h1 class="fw-bold d-flex align-items-center fs-5 mb-0">Hi, Courtney Henry</h1>
                                <span class="text-gray-400  fw-semibold fs-6 profile_box_date">Saturday, 15 Mar 2023</span>
                            </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                        <a href="<?=base_url('analytics')?>">
                            <img alt="Logo" src="<?=base_url()?>assests/admin-assets/images/Logo_DENIR_PNG.png" class="h-25px app-sidebar-logo-default theme-light-show" />
                            <img alt="Logo" src="<?=base_url()?>assests/admin-assets/images/Logo_DENIR_PNG.png" class="h-25px app-sidebar-logo-default theme-dark-show" />
                            <img alt="Logo" src="<?=base_url()?>assests/admin-assets/images/Logo_DENIR_PNG.png" class="h-20px app-sidebar-logo-minimize" />
                        </a>
                    </div>
                    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                                <div class="menu-item">
                                    <a class="menu-link" href="<?=base_url('my_orders')?>">
                                        <span class="menu-icon">
                                            <img src="<?=base_url()?>assests/admin-assets/images/note.svg">
                                        </span>
                                        <span class="menu-title">My orders</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="<?=base_url('analytics')?>">
                                        <span class="menu-icon">
                                            <img src="<?=base_url()?>assests/admin-assets/images/chart.svg">
                                        </span>
                                        <span class="menu-title">Analytics</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="<?=base_url('message')?>">
                                        <span class="menu-icon">
                                            <img src="<?=base_url()?>assests/admin-assets/images/message-text.svg">
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="<?=base_url('documents')?>">
                                        <span class="menu-icon">
                                            <img src="<?=base_url()?>assests/admin-assets/images/note-2.svg">
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="<?=base_url('contact')?>"> 
                                        <span class="menu-icon">
                                            <img src="<?=base_url()?>assests/admin-assets/images/profile-2user.svg">
                                        </span>
                                        <span class="menu-title">Contacts</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="<?=base_url('sales_support')?>">
                                        <span class="menu-icon">
                                            <img src="<?=base_url()?>assests/admin-assets/images/message-question.svg">
                                        </span>
                                        <span class="menu-title">Sales Support</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="<?=base_url('refund')?>">
                                        <span class="menu-icon">
                                            <img src="<?=base_url()?>assests/admin-assets/images/money-recive.svg">
                                        </span>
                                        <span class="menu-title">Refund & Complaints</span>
                                    </a>
                                </div>
                                <div class="menu-item mt-7">
                                    <a class="menu-link" href="<?=base_url('settings')?>">
                                        <span class="menu-icon">
                                            <img src="<?=base_url()?>assests/admin-assets/images/setting-2.svg">
                                        </span>
                                        <span class="menu-title">Settings</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="<?= base_url('user-logout');?>">
                                        <span class="menu-icon">
                                            <img src="<?=base_url()?>assests/admin-assets/images/logout.svg">
                                        </span>
