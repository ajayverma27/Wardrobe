            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10 cstm_card">
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="post" data-kt-redirect-url="" action="<?php echo base_url('admin/user_register') ?>" enctype="multipart/form-data" accept-charset="utf-8">
                            ...
                            <div class="mb-8">
                                ...
                                <img src="<?= base_url() ?>assests/admin-assets/images/eye-slash.svg" alt="" class="icon_img2" srcset="">
                            </div>
                            <div class="mb-8">
                            ...
                            <div class="d-grid mb-10">
                                <button type="submit" name="submit" id="kt_sign_in_submit" class="btn cstm_primary_btn btn-outline">
                                    <span class="indicator-label">New Passowrd</span>
