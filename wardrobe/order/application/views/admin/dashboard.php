    ...
    <div class="layout-specing">
        <div class="row">
            <div class="col-md-8">
                ...
                <div>
                    <img src="<?=base_url()?>assests/admin-assets/images/sidebar_logo/dashboard_img.png" class="red_image mt-3 " alt="">
                </div>
                <div class="mt-5">
            ...
            <div class="col-md-4" style="border-left: 1px solid #ddd;">
                <div class="d-flex justify-content-center">
                    <img src="<?=base_url()?>assests/admin-assets/images/sidebar_logo/denir.png" class="logo-light-mode mt-3 " alt="">
                </div>
