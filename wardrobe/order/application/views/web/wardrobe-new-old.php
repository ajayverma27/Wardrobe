			...
			<div class="radio-with-Icon floorPlan1">
				<p class="radioOption-Item">
					...
					<label for="planfloor1">
						<img data-dimension="<?=$edge_typea['length'].'-'.$edge_typea['width'].'-'.$edge_typea['depth']?>" src="<?=base_url()?>assests/web_assets/img_web/Typ_A_Pôdorys.jpg" alt="" class="lazy calculate-hwd">
					</label>
				</p>
				...
				<p class="radioOption-Item">
					...
					<label for="planfloor2">
						<img data-dimension="<?=$edge_typeb['length'].'-'.$edge_typeb['width'].'-'.$edge_typeb['depth']?>" src="<?=base_url()?>assests/web_assets/img_web/Typ_B_Pôdorys.jpg" alt="" class="lazy calculate-hwd">
					</label>
				</p>
				...
				<p class="radioOption-Item">
					...
					<label for="planfloor3">
						<img data-dimension="<?=$edge_typec['length'].'-'.$edge_typec['width'].'-'.$edge_typec['depth']?>" src="<?=base_url()?>assests/web_assets/img_web/Typ_C_Pôdorys.jpg" alt="" class="lazy calculate-hwd">
					</label>
				</p>
				<p class="radioOption-Item">
					...
					<label for="planfloor4">
						<img data-dimension="<?=$edge_typed['length'].'-'.$edge_typed['width'].'-'.$edge_typed['depth']?>" src="<?=base_url()?>assests/web_assets/img_web/Typ_D_Pôdorys.jpg" alt="" class="lazy calculate-hwd">
					</label>
				</p>
			</div>
			...
			<div class="account-details-form">
				...
				<div class="row" style="display: none;">
					...
					<div class="col-md-3 d-flex flex-column justify-content-around">
					    <div class="align-items-center d-flex">
							<label class="lbl_sides font-weight-bolder">Right rear height<br><small class="font-weight-bolder"></small></label>
							<input type="text" placeholder="" id="length_check_3" class="para_rfh2 mx-1 vyskaRight1 height_cuboid setInpWidth" maxlength="5"> <span class="font-weight-bolder text-dark"> mm </span>
						</div>
						<p class="text-danger font-weight-bolder" id="err-right" style="display:none;">Minimum: 600mm </p>
