                                ...
                                <tr>
                                    <td style="padding:0 35px;text-align: start;">
                                        ...
                                        <p style="font-size: 16px;font-weight: 500;">
                                            Denir.sk | Potvrdenie objednávky ohranenej dosky.</p>
                                    ...
                                    <td style="padding:0 45px">
                                        <table style="width:670px;border: 1px solid #000;margin-top: 18px;">
                                            ...
                                            <td style="height: 200px;">
                                                <a href=""> 
                                                    <img
                                                        src="https://wardrobe.zarfrestauracia.sk/assests/web_assets/img_web/Skrinka.jpg"
                                                        class="img-fluid config-image" alt=""
