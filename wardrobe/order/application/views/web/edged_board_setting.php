...
<div class="page slide-page">
    ...
    <div class="row mt-2">
        ...
        <tr id="tr-0">
            <td class="font12 align-middle"><button type="button" class="btn add_btn1 duplicate-row-btn p-0" data-row="0" ><img src="<?=base_url()?>assests/web_assets/images/copy.png" alt="" class="image-fluid h35 "></button></td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="ml-3">
                ...
                <button type="button" class="btn btn-danger abs-confirm-btn-1" >Remove</button>
            </div>
            </div>
        </div>
    </div>
    ...
    $('.append-tbl-data').click(function(){
        var burl = '<?=base_url()?>';
         var row = `<tr id="tr-${trinc}">
            <td class="font12 align-middle"><button type="button" class="btn add_btn1 duplicate-row-btn p-0" data-row="${trinc}" ><img src="${burl}assests/web_assets/images/copy.png" alt="" class="image-fluid h35 "></button></td>
            <td class="align-middle p-0">
...
$('.final-step').click(function(){
        ...
        <div class="mt-20">
            ...
            summary += `<tr>
            <th style="width:50%;">Row ${index+1}</th>
            <td style="width:50%;">
                <span class="calc_panel ">Thickness : ${thick}mm</span>
                <span class="calc_panel ">Width : ${w}mm</span>
                <span class="calc_panel ">Length : ${l}mm</span><br><br>
                <span class="calc_panel ">DTD Cost : ${dtdprice}€</span>
                <span class="calc_panel ">ABS Cost : ${absprice}€</span><br><br>
                <span class="calc_panel ">Total Cost : ${price1}€ s DPH</span>
                <span class="calc_panel ">Total Cost : ${price}€ bez DPH</span>
            </td>
            </tr>`;
