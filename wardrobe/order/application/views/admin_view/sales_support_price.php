    ...
    <div class="d-flex flex-column flex-column-fluid">
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <h6 class="book_heading">Sales Support <span> <img src="assets/images/arrow-right.svg" alt="" srcset=""></span><span class="sample_book_span">Price List - 2023</span></h6>
            </div>
        </div>
                    ...
                    <div class="d-flex align-items-center btn_index_ch gap-2">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            <button type="button" class=" new_order_btn" id="tutoral_category_modal">
                                <span><img src="assets/images/add.svg" class="img-fluid me-2">Add Price List
                                </span></button>
                        </div>
                    </div>
                </div>
