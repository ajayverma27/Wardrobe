...
<head>
    ...
    <link href="<?=base_url()?>assets/admin2-assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
					    <img src="<?=base_url()?>assests/admin2-assets/images/Logo_DENIR.png" class="logo_denir mb-7">
						<div class="w-lg-500px p-10 cstm_card">
							<?php $msg = $this->session->flashdata('msg'); ?> 
							<p style="color:red;"><?php echo $msg = $this->session->flashdata('msg'); ?></p>
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="post" data-kt-redirect-url="" action='<?php echo base_url('Admin_Login/admin_login') ?>'>
...
<script src="<?php echo base_url()?>assests/admin2-assets//plugins/global/plugins.bundle.js"></script>
